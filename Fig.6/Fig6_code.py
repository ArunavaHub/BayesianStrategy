    ...
    for e in range(average):
        ...
        for k in range(0,no_of_round):
            ...
            if k==0:
                ...
                prior_distribution,p_max,q_max=Bayes_update(action_reactive,p,q,bayesian_strategy[2],prior_distribution)
                
                ## Strategy updating===================================
                bayesian_strategy[0]=1-(1-p_max)*(1-Gen_paramater)
                bayesian_strategy[1]=1-(1-q_max)*(1-Gen_paramater)
            else:
                ...
                prior_distribution,p_max,q_max=Bayes_update(action_reactive,p,q,cop_Bayesian[k-1],prior_distribution)
    ...
    for e in range(average):
        ...
        for k in range(0,no_of_round):
            ...
            if k==0:
                ...
                prior_distribution_bayesian_1,p_max_1,q_max_1=Bayes_update(action_bayesian_2, p, q, bayesian_strategy_1[2], prior_distribution_bayesian_1)
                prior_distribution_bayesian_2,p_max_2,q_max_2=Bayes_update(action_bayesian_1, p, q, bayesian_strategy_2[2], prior_distribution_bayesian_2)
                
                ## Strategy updating==================================
                bayesian_strategy_1[0]=1-(1-p_max_1)*(1-Gen_paramater)
                bayesian_strategy_1[1]=1-(1-q_max_1)*(1-Gen_paramater)
                bayesian_strategy_2[0]=1-(1-p_max_2)*(1-Gen_paramater)
                bayesian_strategy_2[1]=1-(1-q_max_2)*(1-Gen_paramater)
            else:
                ...
                prior_distribution_bayesian_1,p_max_1,q_max_1=Bayes_update(action_bayesian_2, p, q, cop_Bayesian_1[k-1], prior_distribution_bayesian_1)
                prior_distribution_bayesian_2,p_max_2,q_max_2=Bayes_update(action_bayesian_1, p, q, cop_Bayesian_2[k-1], prior_distribution_bayesian_2)
...
np.savetxt('matrix_element_aRR_df=0.75_r=10.0_gamma=0.5_c=0.5_avg_10k_pq_51.txt',a)
np.savetxt('matrix_element_bRB_df=0.75_r=10.0_gamma=0.5_c=0.5_avg_10k_pq_51.txt',b)
np.savetxt('matrix_element_cBR_df=0.75_r=10.0_gamma=0.5_c=0.5_avg_10k_pq_51.txt',c)
np.savetxt('matrix_element_dBB_df=0.75_r=10.0_gamma=0.5_c=0.5_avg_10k_pq_51.txt',d)
