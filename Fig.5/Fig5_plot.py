...
## Import the data=========================================================================================
a=np.loadtxt('matrix_element_aRR_df=0.99_r=2.0_nu=0.5_c=0.5_avg_10k_pq_51.txt')
b=np.loadtxt('matrix_element_bRB_df=0.99_r=2.0_nu=0.5_c=0.5_avg_10k_pq_51.txt')
c=np.loadtxt('matrix_element_cBR_df=0.99_r=2.0_nu=0.5_c=0.5_avg_10k_pq_51.txt')
d=np.loadtxt('matrix_element_dBB_df=0.99_r=2.0_nu=0.5_c=0.5_avg_10k_pq_51.txt')
...
plt.yticks(xticks,fontsize=50)
plt.savefig("Fig5(f).png",dpi=600)
plt.show()
