    ...
    for e in range(average):
        ...
        for k in range(0,no_of_round):
            ...
            if k==0:
                ...
                ## Strategy updating==================================
                bayesian_strategy[0]=p_max*(1-reci_paramater)
                bayesian_strategy[1]=q_max*(1-reci_paramater)
            else:
...
#Payoff of two Bayesian players==================================================================================================
    ...
    for e in range(average):
        ...
        for k in range(0,no_of_round):
            ...
            if k==0:
                ...
                ## Strategy updating==================================
                bayesian_strategy_1[0]=p_max_1*(1-reci_paramater)
                bayesian_strategy_1[1]=q_max_1*(1-reci_paramater)
                bayesian_strategy_2[0]=p_max_2*(1-reci_paramater)
                bayesian_strategy_2[1]=q_max_2*(1-reci_paramater)
            else:
...
np.savetxt('matrix_element_aRR_df=0.75_r=10.0_nu=0.3_c=0.5_avg_10k_pq_51.txt',a)
np.savetxt('matrix_element_bRB_df=0.75_r=10.0_nu=0.3_c=0.5_avg_10k_pq_51.txt',b)
np.savetxt('matrix_element_cBR_df=0.75_r=10.0_nu=0.3_c=0.5_avg_10k_pq_51.txt',c)
np.savetxt('matrix_element_dBB_df=0.75_r=10.0_nu=0.3_c=0.5_avg_10k_pq_51.txt',d)
